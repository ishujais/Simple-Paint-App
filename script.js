...
canvas.addEventListener('mousemove', function (e) {
    ...
    if (isActive && flag) {
        ...
        reDrawTriangles(startCoordinates.x, startCoordinates.y,
            calculateLineDistance(startCoordinates.x, startCoordinates.y, endCoordinates.x, endCoordinates.y), randomRGB);
        dataPool.forEach(function (value) {
...
function drawTriangle(mode, x1, y1, x2, y2) {
    ...
    context.fill();
    dataPool.push([[x1, y1], [x1 + distance / 2, y1 + height * 1.25],
        [x1 - distance / 2, y1 + height * 1.25],
        [context.fillStyle], [distance]]);
}
